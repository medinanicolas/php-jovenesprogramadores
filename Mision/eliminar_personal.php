		...
		<?php
			...
			y se muestra alerta con mensaje*/	
			 if (isset($_POST['eliminar'])) {
				...
				$consulta = "DELETE FROM personal WHERE rut = '$eliminar'"; //Se elimina el usuario asignado en eliminar de la db personal
				$ejecutar=mysql_query($consulta,$conexion); //se ejecuta la consulta
				header("Location:eliminar_personal.php"); //se redirige a la pagina de eliminacion de personal y se muestran los cambios
