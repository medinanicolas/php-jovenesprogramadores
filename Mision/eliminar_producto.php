...
<html>
	...
	<body>
		<div class="contenedor">
			...
			<?php
				if(isset($_POST['eliminar'])){ //si se apreta el boton entonces
				$eliminar=$_POST['eliminar-producto']; //eliminar ahora es el codigo de producto
				$consulta= "DELETE FROM productos WHERE cod_producto = '$eliminar'"; //se dispone a eliminar cod_producto = eliminar
